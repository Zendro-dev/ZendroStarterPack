    ...
    <div id="transcript_count-div">
      <div v-if="transcript_count" class="content">
        <form id="transcript_count-form" v-on:submit.prevent="onSubmit">
          ...
          <transcript_count-form-elemns mode="create" v-bind:errors="errors" v-bind:transcript_count="transcript_count"></transcript_count-form-elemns>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      Queries.Transcript_count.create({url:url, variables: t.transcript_count})
