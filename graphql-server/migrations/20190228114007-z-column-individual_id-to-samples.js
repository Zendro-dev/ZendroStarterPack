...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('samples', 'individual_id', {
            ...
            return queryInterface.addIndex('samples', ['individual_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('samples', 'individual_id');
    }
