  ...
  <input type="text" v-model="individual.description" class="form-control"/>
    ...
    <div id="individual-marker_data_snps-div" class="form-group">
      ...
      <has-many-form-element
        ...
        :countQuery="individual.countFilteredMarkerdata"
        :mode="mode"
        :addItems.sync="individual.addMarkerdata"
        label="marker_name"
                    subLabel ="nucleotide"
                valueKey="id"
        model="Individual"
        targetModel = "Markerdata"
        removeName="removeMarkerdata"
        addName="addMarkerdata"
