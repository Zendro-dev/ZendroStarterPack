<template>
  ...
  <input type="text" v-model="sample.tissue" class="form-control"/>
    ...
    <div id="sample-sequencingexperiment-div" class="form-group">
      ...
      <foreign-key-form-element
        ...
        label="name"
                    subLabel = "platform"
                        valueKey="id"
        targetModel="Sequencingexperiment"
        v-bind:initialInput="sequencingexperimentInitialLabel">
      </foreign-key-form-element>
    </div>
    ...
    <div id="sample-library_data-div" class="form-group">
      ...
      <has-many-form-element
        ...
        :countQuery="sample.countFilteredNucacidlibraryresults"
        :mode="mode"
        :addItems.sync="sample.addNucacidlibraryresults"
        label="lab_code"
                    subLabel ="file_name"
                valueKey="id"
        model="Sample"
