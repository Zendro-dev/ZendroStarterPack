...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('genotypes', 'breeding_pool_id', {
            type: Sequelize.INTEGER,
            references: {
                model: 'breeding_pools',
                key: 'id'
            }
        }).then(() => {
            return queryInterface.addIndex('genotypes', ['breeding_pool_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('genotypes', 'breeding_pool_id');
    }
