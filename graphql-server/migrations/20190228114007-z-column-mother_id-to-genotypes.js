...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('genotypes', 'mother_id', {
            ...
            return queryInterface.addIndex('genotypes', ['mother_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('genotypes', 'mother_id');
    }
