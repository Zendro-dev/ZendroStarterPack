<template>
  <div class="ui container">
    ...
    <vuetable ref="vuetable"
      ...
      pagination-path="data.vueTableField_plot"
      detail-row-component="field_plot-detail-row"
      data-path="data.vueTableField_plot.data"
...
export default {
  ...
  data() {
    return {
      ...
      moreParams: {
        query: `{vueTableField_plot{data {id  field_name coordinates_or_name year area_sqm type genotype{name  id }} total per_page current_page last_page prev_page_url next_page_url from to}}`
      }
    }
  },
  methods: {
