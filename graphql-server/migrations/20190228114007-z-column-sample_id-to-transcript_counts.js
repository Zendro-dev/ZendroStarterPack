...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('transcript_counts', 'sample_id', {
            ...
            return queryInterface.addIndex('transcript_counts', ['sample_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('transcript_counts', 'sample_id');
    }
