<template>
  <div class="col-xs-5">
    <h4>New nucacidlibraryresult</h4>
    <div id="nucacidlibraryresult-div">
      <div v-if="nucacidlibraryresult" class="content">
        <form id="nucacidlibraryresult-form" v-on:submit.prevent="onSubmit">
          ...
          <nucacidlibraryresult-form-elemns mode="create" v-bind:errors="errors" v-bind:nucacidlibraryresult="nucacidlibraryresult"></nucacidlibraryresult-form-elemns>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      Queries.Nucacidlibraryresult.create({url:url, variables: t.nucacidlibraryresult})
