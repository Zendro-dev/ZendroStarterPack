...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('measurements', 'field_plot_id', {
            ...
            return queryInterface.addIndex('measurements', ['field_plot_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('measurements', 'field_plot_id');
    }
