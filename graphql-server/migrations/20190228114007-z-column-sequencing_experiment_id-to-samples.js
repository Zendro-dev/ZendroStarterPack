...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('samples', 'sequencing_experiment_id', {
            type: Sequelize.INTEGER,
            references: {
                model: 'sequencing_experiments',
                key: 'id'
            }
        }).then(() => {
            return queryInterface.addIndex('samples', ['sequencing_experiment_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('samples', 'sequencing_experiment_id');
    }
