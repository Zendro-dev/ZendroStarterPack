    ...
    <div id="field_plot-div">
      <div v-if="field_plot" class="content">
        <form id="field_plot-form" v-on:submit.prevent="onSubmit">
          ...
          <field_plot-form-elemns mode="create" v-bind:errors="errors" v-bind:field_plot="field_plot"></field_plot-form-elemns>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      Queries.Field_plot.create({url:url, variables: t.field_plot})
