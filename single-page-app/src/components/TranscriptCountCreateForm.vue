    ...
    <div id="transcriptcount-div">
      <div v-if="transcriptcount" class="content">
        <form id="transcriptcount-form" v-on:submit.prevent="onSubmit">
          ...
          <transcriptcount-form-elemns mode="create" v-bind:errors="errors" v-bind:transcriptcount="transcriptcount"></transcriptcount-form-elemns>
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      Queries.Transcriptcount.create({url:url, variables: t.transcriptcount})
