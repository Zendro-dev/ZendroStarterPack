...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('field_plots', 'genotype_id', {
            ...
            return queryInterface.addIndex('field_plots', ['genotype_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('field_plots', 'genotype_id');
    }
