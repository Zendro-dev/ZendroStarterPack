...
export default {
  ...
  data() {
    return {
      ...
      moreParams: {
        query: `{vueTableTranscriptcount{data {id  gene value method reference_genome sample{name  tissue }} total per_page current_page last_page prev_page_url next_page_url from to}}`
      }
    }
  },
  methods: {
