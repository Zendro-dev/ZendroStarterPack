...
module.exports = {
    ...
    up: function(queryInterface, Sequelize) {
        return queryInterface.addColumn('genotypes', 'father_id', {
            ...
            return queryInterface.addIndex('genotypes', ['father_id']);
        });
    },
    ...
    down: function(queryInterface, Sequelize) {
        return queryInterface.removeColumn('genotypes', 'father_id');
    }
